				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em
								id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${sessionScope.operator.nike}</span>
							<i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li><a href="javascript:void(0)"
								name="operator/info?id=${sessionScope.operator.id}" title="个人信息"
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="product/index" title="产品类表" class="iframeurl"><i
										class="icon-double-angle-right"></i>产品类表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="type/index" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-picture "></i><span class="menu-text"> 购物车管理
							</span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="shopcar/index" title="查看购物车" class="iframeurl"><i
										class="icon-double-angle-right"></i>查看购物车</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-picture "></i><span class="menu-text"> 订单管理 </span><b
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="orders/index" title="查看订单" class="iframeurl"><i
										class="icon-double-angle-right"></i>查看订单</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="operator/index" title="管理员列表" class="iframeurl"><i
