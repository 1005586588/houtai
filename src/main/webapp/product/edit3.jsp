   ...
   <div class="type_title">添加商品</div>
	...
	<c:if test="${requestScope.info!=null}">
		...
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>商品全名：</label>
		...
		<div class=" clearfix cl">
         <label class="form-label col-2">活动：</label>
	     <div class="formControls col-10">
		 <input type="text" class="input-text" value="${requestScope.info.activity}"  name="activity" >
	     </div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2">提示信息：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.tip}" >
			</div>
		</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.price}" >
			</div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2">现价格：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.nowprice}" >
			</div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2">销售数量：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.salecount}" >
			</div>
		</div>
		
		<div class="clearfix cl">
			<label class="form-label col-2">收藏人数：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.collectcount}" >
			</div>
		</div>
		<div class="clearfix cl">
			<label class="form-label col-2">优先级：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.priority}" >
			</div>
		</div>
		<div class="clearfix cl">
			...
			<c:forEach items="${requestScope.productstatus}" var="r" varStatus="v">
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.comments}" >
			</div>
		</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="${requestScope.info.pics}" >
			</div>
		</div>						
<form action="a">
